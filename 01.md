...
Reverse proxies or application endpoints must use the CORS Header `Access-Control-Allow-Origin: *` for LNURL's to work with browser-based wallets, services and other webapps. 
